...
namespace RSSigGen.RS
{
    //
    // Сводка:
    //     RsSmab_Source_Sweep_Power_Execute commands group definition
    //     Sub-classes count: 0
    //     Commands count: 1
    //     Total commands count: 1
    public class RsSmab_Source_Sweep_Power_Execute
    {
        private readonly CommandsGroup _grpBase;

        internal RsSmab_Source_Sweep_Power_Execute(Core core, ICmdGroup parent)
        {
        ...
        public void Set()
        {
            _grpBase.IO.Write("SOURce<HwInstance>:SWEep:POWer:EXECute");
        }
        ...
        {
            _grpBase.IO.WriteWithOpc("SOURce<HwInstance>:SWEep:POWer:EXECute", opcTimeoutMs);
        }
    }
}
