...
namespace RSSigGen.RS
{
    //
    // Сводка:
    //     RsSmab_Status_Operation_Bit_Condition commands group definition
    //     Sub-classes count: 0
    //     Commands count: 1
    //     Total commands count: 1
    public class RsSmab_Status_Operation_Bit_Condition
    {
        private readonly CommandsGroup _grpBase;

        internal RsSmab_Status_Operation_Bit_Condition(Core core, ICmdGroup parent)
        {
        ...
        public string Get(BitNumberNullRepCap bitNumberNull)
        {
            ...
            return _grpBase.IO.QueryString("STATus:OPERation:BIT" + repCapCmdValue + ":CONDition?").TrimStringResponse();
        }
    }
}
