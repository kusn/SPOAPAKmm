...
namespace RSSigGen.RS
{
    //
    // Сводка:
    //     RsSmab_Status_Operation_Bit_Enable commands group definition
    //     Sub-classes count: 0
    //     Commands count: 1
    //     Total commands count: 1
    public class RsSmab_Status_Operation_Bit_Enable
    {
        private readonly CommandsGroup _grpBase;

        internal RsSmab_Status_Operation_Bit_Enable(Core core, ICmdGroup parent)
        {
        ...
        public void Set(string enable, BitNumberNullRepCap bitNumberNull)
        {
            ...
            _grpBase.IO.Write("STATus:OPERation:BIT" + repCapCmdValue + ":ENABle " + enable.EncloseByQuotes());
        }
        ...
        {
            string repCapCmdValue = _grpBase.GetRepCapCmdValue(bitNumberNull);
            return _grpBase.IO.QueryString("STATus:OPERation:BIT" + repCapCmdValue + ":ENABle?").TrimStringResponse();
        }
    }
}
