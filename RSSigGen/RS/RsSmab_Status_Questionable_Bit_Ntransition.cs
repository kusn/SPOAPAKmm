...
namespace RSSigGen.RS
{
    //
    // Сводка:
    //     RsSmab_Status_Questionable_Bit_Ntransition commands group definition
    //     Sub-classes count: 0
    //     Commands count: 1
    //     Total commands count: 1
    public class RsSmab_Status_Questionable_Bit_Ntransition
    {
        private readonly CommandsGroup _grpBase;

        internal RsSmab_Status_Questionable_Bit_Ntransition(Core core, ICmdGroup parent)
        {
        ...
        public void Set(string ntransition, BitNumberNullRepCap bitNumberNull)
        {
            ...
            _grpBase.IO.Write("STATus:QUEStionable:BIT" + repCapCmdValue + ":NTRansition " + ntransition.EncloseByQuotes());
        }
        ...
        {
            string repCapCmdValue = _grpBase.GetRepCapCmdValue(bitNumberNull);
            return _grpBase.IO.QueryString("STATus:QUEStionable:BIT" + repCapCmdValue + ":NTRansition?").TrimStringResponse();
        }
    }
}
