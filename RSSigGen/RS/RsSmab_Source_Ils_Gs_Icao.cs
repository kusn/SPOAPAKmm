...
namespace RSSigGen.RS
{
    //
    // Сводка:
    //     RsSmab_Source_Ils_Gs_Icao commands group definition
    //     Sub-classes count: 0
    //     Commands count: 1
    //     Total commands count: 1
    public class RsSmab_Source_Ils_Gs_Icao
    {
        ...
        public AvionicIlsIcaoChanEnum Channel
        {
            get
            {
                return _grpBase.IO.QueryString("SOURce<HwInstance>:ILS:GS:ICAO:CHANnel?").ToScpiEnum<AvionicIlsIcaoChanEnum>();
            }
            set
            {
                _grpBase.IO.Write("SOURce<HwInstance>:ILS:GS:ICAO:CHANnel " + value.ToScpiString());
            }
        }

        internal RsSmab_Source_Ils_Gs_Icao(Core core, ICmdGroup parent)
        {
