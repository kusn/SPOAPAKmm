...
{
    public class RsSmab_Calculate_Power_Sweep_Power_Math_Subtract
    {
        private readonly CommandsGroup _grpBase;

        internal RsSmab_Calculate_Power_Sweep_Power_Math_Subtract(Core core, ICmdGroup parent)
        {
        ...
        public void Set(MeasRespMathEnum subtract, MathRepCap math)
        {
            ...
            _grpBase.IO.Write("CALCulate:POWer:SWEep:POWer:MATH" + repCapCmdValue + ":SUBTract " + subtract.ToScpiString());
        }
        ...
        {
            string repCapCmdValue = _grpBase.GetRepCapCmdValue(math);
            return _grpBase.IO.QueryString("CALCulate:POWer:SWEep:POWer:MATH" + repCapCmdValue + ":SUBTract?").ToScpiEnum<MeasRespMathEnum>();
        }
    }
}
