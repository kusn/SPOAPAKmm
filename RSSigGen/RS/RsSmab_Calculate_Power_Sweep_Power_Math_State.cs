...
{
    public class RsSmab_Calculate_Power_Sweep_Power_Math_State
    {
        private readonly CommandsGroup _grpBase;

        internal RsSmab_Calculate_Power_Sweep_Power_Math_State(Core core, ICmdGroup parent)
        {
        ...
        //     Activates the trace mathematics mode for "Power" measurement. This feature enables
        ...
        public void Set(bool state, MathRepCap math)
        {
            ...
            _grpBase.IO.Write("CALCulate:POWer:SWEep:POWer:MATH" + repCapCmdValue + ":STATe " + state.ToBooleanString());
        }
        ...
        {
            string repCapCmdValue = _grpBase.GetRepCapCmdValue(math);
            return _grpBase.IO.QueryBoolean("CALCulate:POWer:SWEep:POWer:MATH" + repCapCmdValue + ":STATe?");
        }
    }
}
