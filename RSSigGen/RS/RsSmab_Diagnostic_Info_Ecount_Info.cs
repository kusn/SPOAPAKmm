...
{
    public class RsSmab_Diagnostic_Info_Ecount_Info
    {
        private readonly CommandsGroup _grpBase;

        internal RsSmab_Diagnostic_Info_Ecount_Info(Core core, ICmdGroup parent)
        {
        ...
        public string Get(ErrorCountRepCap errorCount)
        {
            ...
            return _grpBase.IO.QueryString("DIAGnostic:INFO:ECOunt" + repCapCmdValue + ":INFO?").TrimStringResponse();
        }
    }
}
