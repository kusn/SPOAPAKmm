...
namespace RSSigGen.RS
{
    //
    // Сводка:
    //     RsSmab_Sense_Power_Sweep_Power_Yscale_Auto commands group definition
    //     Sub-classes count: 0
    //     Commands count: 2
    //     Total commands count: 2
    public class RsSmab_Sense_Power_Sweep_Power_Yscale_Auto
    {
        ...
        public MeasRespYsCaleModeEnum Value
        {
            get
            {
                return _grpBase.IO.QueryString("SENSe:POWer:SWEep:POWer:YSCale:AUTO?").ToScpiEnum<MeasRespYsCaleModeEnum>();
            }
            set
            {
                _grpBase.IO.Write("SENSe:POWer:SWEep:POWer:YSCale:AUTO " + value.ToScpiString());
            }
        }

        internal RsSmab_Sense_Power_Sweep_Power_Yscale_Auto(Core core, ICmdGroup parent)
        {
        ...
        public void Reset()
        {
            _grpBase.IO.Write("SENSe:POWer:SWEep:POWer:YSCale:AUTO:RESet");
        }
        ...
        {
            _grpBase.IO.WriteWithOpc("SENSe:POWer:SWEep:POWer:YSCale:AUTO:RESet", opcTimeoutMs);
        }
    }
}
