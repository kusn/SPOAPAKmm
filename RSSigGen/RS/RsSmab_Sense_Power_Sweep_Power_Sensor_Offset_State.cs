...
namespace RSSigGen.RS
{
    //
    // Сводка:
    //     RsSmab_Sense_Power_Sweep_Power_Sensor_Offset_State commands group definition
    //     Sub-classes count: 0
    //     Commands count: 1
    //     Total commands count: 1
    public class RsSmab_Sense_Power_Sweep_Power_Sensor_Offset_State
    {
        private readonly CommandsGroup _grpBase;

        internal RsSmab_Sense_Power_Sweep_Power_Sensor_Offset_State(Core core, ICmdGroup parent)
        {
        ...
        public void Set(bool state, ChannelRepCap channel)
        {
            ...
            _grpBase.IO.Write("SENSe" + repCapCmdValue + ":POWer:SWEep:POWer:SENSor:OFFSet:STATe " + state.ToBooleanString());
        }
        ...
        {
            string repCapCmdValue = _grpBase.GetRepCapCmdValue(channel);
            return _grpBase.IO.QueryBoolean("SENSe" + repCapCmdValue + ":POWer:SWEep:POWer:SENSor:OFFSet:STATe?");
        }
    }
}
