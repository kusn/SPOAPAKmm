...
namespace RSSigGen.RS
{
    //
    // Сводка:
    //     RsSmab_Status_Operation_Bit_Event commands group definition
    //     Sub-classes count: 0
    //     Commands count: 1
    //     Total commands count: 1
    public class RsSmab_Status_Operation_Bit_Event
    {
        private readonly CommandsGroup _grpBase;

        internal RsSmab_Status_Operation_Bit_Event(Core core, ICmdGroup parent)
        {
        ...
        public string Get(BitNumberNullRepCap bitNumberNull)
        {
            ...
            return _grpBase.IO.QueryString("STATus:OPERation:BIT" + repCapCmdValue + ":EVENt?").TrimStringResponse();
        }
    }
}
