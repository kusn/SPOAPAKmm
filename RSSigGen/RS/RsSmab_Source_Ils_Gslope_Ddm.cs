...
namespace RSSigGen.RS
{
    //
    // Сводка:
    //     RsSmab_Source_Ils_Gslope_Ddm commands group definition
    //     Sub-classes count: 0
    //     Commands count: 8
    //     Total commands count: 8
    public class RsSmab_Source_Ils_Gslope_Ddm
    {
        ...
        public AvionicIlsDdmCoupEnum Coupling
        {
            get
            {
                return _grpBase.IO.QueryString("SOURce<HwInstance>:ILS:GSLope:DDM:COUPling?").ToScpiEnum<AvionicIlsDdmCoupEnum>();
            }
            set
            {
                _grpBase.IO.Write("SOURce<HwInstance>:ILS:GSLope:DDM:COUPling " + value.ToScpiString());
            }
        }
        ...
        public double Current
        {
            get
            {
                return _grpBase.IO.QueryDouble("SOURce<HwInstance>:ILS:GSLope:DDM:CURRent?");
            }
            set
            {
                _grpBase.IO.Write("SOURce<HwInstance>:ILS:GSLope:DDM:CURRent " + value.ToDoubleString());
            }
        }
        ...
        public UpDownDirectionEnum Direction
        {
            get
            {
                return _grpBase.IO.QueryString("SOURce<HwInstance>:ILS:GSLope:DDM:DIRection?").ToScpiEnum<UpDownDirectionEnum>();
            }
            set
            {
                _grpBase.IO.Write("SOURce<HwInstance>:ILS:GSLope:DDM:DIRection " + value.ToScpiString());
            }
        }
        ...
        public double Logarithmic
        {
            get
            {
                return _grpBase.IO.QueryDouble("SOURce<HwInstance>:ILS:GSLope:DDM:LOGarithmic?");
            }
            set
            {
                _grpBase.IO.Write("SOURce<HwInstance>:ILS:GSLope:DDM:LOGarithmic " + value.ToDoubleString());
            }
        }
        ...
        public double Pct
        {
            get
            {
                return _grpBase.IO.QueryDouble("SOURce<HwInstance>:ILS:GSLope:DDM:PCT?");
            }
            set
            {
                _grpBase.IO.Write("SOURce<HwInstance>:ILS:GSLope:DDM:PCT " + value.ToDoubleString());
            }
        }
        ...
        public AvionicIlsDdmPolEnum Polarity
        {
            get
            {
                return _grpBase.IO.QueryString("SOURce<HwInstance>:ILS:GSLope:DDM:POLarity?").ToScpiEnum<AvionicIlsDdmPolEnum>();
            }
            set
            {
                _grpBase.IO.Write("SOURce<HwInstance>:ILS:GSLope:DDM:POLarity " + value.ToScpiString());
            }
        }
        ...
        public AvionicDdmStepEnum Step
        {
            get
            {
                return _grpBase.IO.QueryString("SOURce<HwInstance>:ILS:GSLope:DDM:STEP?").ToScpiEnum<AvionicDdmStepEnum>();
            }
            set
            {
                _grpBase.IO.Write("SOURce<HwInstance>:ILS:GSLope:DDM:STEP " + value.ToScpiString());
            }
        }
        ...
        public double Depth
        {
            get
            {
                return _grpBase.IO.QueryDouble("SOURce<HwInstance>:ILS:GSLope:DDM:DEPTh?");
            }
            set
            {
                _grpBase.IO.Write("SOURce<HwInstance>:ILS:GSLope:DDM:DEPTh " + value.ToDoubleString());
            }
        }

        internal RsSmab_Source_Ils_Gslope_Ddm(Core core, ICmdGroup parent)
        {
