...
namespace RSSigGen.RS
{
    //
    // Сводка:
    //     RsSmab_Source_Ils_Gslope_Icao commands group definition
    //     Sub-classes count: 0
    //     Commands count: 1
    //     Total commands count: 1
    public class RsSmab_Source_Ils_Gslope_Icao
    {
        ...
        //     channel: CH18X| CH18Y| CH20X| CH20Y| CH22X| CH22Y| CH24X| CH24Y| CH26X| CH26Y|
        ...
        public AvionicIlsIcaoChanEnum Channel
        {
            get
            {
                return _grpBase.IO.QueryString("SOURce<HwInstance>:ILS:GSLope:ICAO:CHANnel?").ToScpiEnum<AvionicIlsIcaoChanEnum>();
            }
            set
            {
                _grpBase.IO.Write("SOURce<HwInstance>:ILS:GSLope:ICAO:CHANnel " + value.ToScpiString());
            }
        }

        internal RsSmab_Source_Ils_Gslope_Icao(Core core, ICmdGroup parent)
        {
