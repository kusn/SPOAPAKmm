...
namespace RSSigGen.RS
{
    //
    // Сводка:
    //     RsSmab_Trigger_FreqSweep_Source commands group definition
    //     Sub-classes count: 1
    //     Commands count: 1
    //     Total commands count: 2
    public class RsSmab_Trigger_FreqSweep_Source
    {
        private readonly CommandsGroup _grpBase;

        private RsSmab_Trigger_FreqSweep_Source_Advanced _advanced;
        ...
        public RsSmab_Trigger_FreqSweep_Source_Advanced Advanced => _advanced ?? (_advanced = new RsSmab_Trigger_FreqSweep_Source_Advanced(_grpBase.Core, _grpBase));

        internal RsSmab_Trigger_FreqSweep_Source(Core core, ICmdGroup parent)
        {
        ...
        public RsSmab_Trigger_FreqSweep_Source Clone()
        {
            RsSmab_Trigger_FreqSweep_Source rsSmab_Trigger_FreqSweep_Source = new RsSmab_Trigger_FreqSweep_Source(_grpBase.Core, _grpBase.Parent);
            _grpBase.SynchroniseRepCaps(rsSmab_Trigger_FreqSweep_Source);
            return rsSmab_Trigger_FreqSweep_Source;
        }
        ...
        public void Set(SingExtAutoEnum source, InputIxRepCap inputIx)
        {
            ...
            _grpBase.IO.Write("TRIGger" + repCapCmdValue + ":FSWeep:SOURce " + source.ToScpiString());
        }
        ...
        {
            string repCapCmdValue = _grpBase.GetRepCapCmdValue(inputIx);
            return _grpBase.IO.QueryString("TRIGger" + repCapCmdValue + ":FSWeep:SOURce?").ToScpiEnum<SingExtAutoEnum>();
        }
    }
}
