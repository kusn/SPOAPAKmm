...
namespace RSSigGen.RS
{
    //
    // Сводка:
    //     RsSmab_Trigger_Sweep_Immediate commands group definition
    //     Sub-classes count: 0
    //     Commands count: 1
    //     Total commands count: 1
    public class RsSmab_Trigger_Sweep_Immediate
    {
        private readonly CommandsGroup _grpBase;

        internal RsSmab_Trigger_Sweep_Immediate(Core core, ICmdGroup parent)
        {
        ...
        public void Set(InputIxRepCap inputIx)
        {
            ...
            _grpBase.IO.Write("TRIGger" + repCapCmdValue + ":SWEep:IMMediate");
        }
        ...
        {
            string repCapCmdValue = _grpBase.GetRepCapCmdValue(inputIx);
            _grpBase.IO.WriteWithOpc("TRIGger" + repCapCmdValue + ":SWEep:IMMediate", opcTimeoutMs);
        }
    }
}
