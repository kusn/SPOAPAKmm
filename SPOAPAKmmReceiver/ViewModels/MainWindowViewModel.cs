    ...
    public class MainWindowViewModel : ViewModel
    {
        ...
        private void OnCreateReportCommandExecuted(object p)
        {
            ...
            if (SelectedValue is Room)
            {
                ...
                var devicesRows = new List<TableRowContent>();
                var elementsRows = new List<TableRowContent>();
                ...
                var unicFreqList = new List<double>();
                foreach (var element in room.Elements)
                ...
                var minMeasureItemsList = new List<MeasureItem>();
                i = 3;
