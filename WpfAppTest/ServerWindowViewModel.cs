...
using WpfAppTest.SimplePackets;

namespace WpfAppTest
{
    public class ServerWindowViewModel : ViewModel
    {
        private string _externalAddress;
        public string ExternalAddress
        {
            get => _externalAddress;
            set => Set(ref _externalAddress, value);
        }
        ...
        public int ClientsConnected
        {
            ...
            set => Set(ref _clientsConnected, value);
        }
        ...
        private void GetExternalIp()
        {
            try
            {
                ...
                ExternalAddress = host.AddressList.First(ip => ip.AddressFamily == AddressFamily.InterNetwork).ToString();
                //foreach (var ip in host.AddressList)
                //{
                //    if (ip.AddressFamily == AddressFamily.InterNetwork)
                //    {
                //        ExternalAddress = ip.ToString();
                //    }
                //}
            }
            catch
